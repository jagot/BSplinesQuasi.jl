...
@testset "Derivatives" begin
    @testset "Derivative operators" begin
        ...
        @testset "k = 7" begin
            ...
            @test BSplinesQuasi.diffop!(similar(B.S), B, 3) ≈
            ...
            @test BSplinesQuasi.diffop!(similar(B.S), B, 4) ≈
            ...
            @test BSplinesQuasi.diffop!(similar(B.S), B, 5) ≈
            ...
            @test BSplinesQuasi.diffop!(similar(B.S), B, 6) ≈
    ...
    @testset "Derivative accuracy" begin
        ...
        Ns = ceil.(Int, 10 .^ range(2, stop=3.5, length=10))
        @testset "k = $k" for k = 3:6
            ϵg,ϵh,pg,ph = compute_derivative_errors(a, b, k, Ns, f, g, h)
